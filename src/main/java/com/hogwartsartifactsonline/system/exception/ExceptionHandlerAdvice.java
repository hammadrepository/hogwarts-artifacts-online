...
public class ExceptionHandlerAdvice {
    ...
    Result handleObjectNotFoundException(ObjectNotFoundException objectNotFoundException){
        return new Result(false, StatusCode.NOT_FOUND, objectNotFoundException.getMessage());
    }
    /**
